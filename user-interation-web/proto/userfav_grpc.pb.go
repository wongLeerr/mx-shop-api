...
// UnimplementedUserFavServer must be embedded to have
...
func (UnimplementedUserFavServer) testEmbeddedByValue()                 {}
...
func RegisterUserFavServer(s grpc.ServiceRegistrar, srv UserFavServer) {
	// If the following call pancis, it indicates UnimplementedUserFavServer was
